...
const getConversations = async (req, res) => {
    ...
    try {
        const result = await pool.query(
            ...
            SELECT u.id, u.name, u.email, u.phone_number as phone, u.address, u.province_id, u.district_id, u.ward_code, lm.message as last_message, lm.created_at as last_message_time
            FROM users u
